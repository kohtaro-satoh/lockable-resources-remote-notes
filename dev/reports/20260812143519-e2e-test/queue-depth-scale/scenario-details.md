...
| CP04 | depth 1: promotion latency | holder release -> first waiter served | (observed) | 48ms | INFO |
| CP05 | depth 1: drain time (includes client notice latency) | holder release -> last waiter served | (observed) | 48ms | INFO |
...
| CP10 | depth 10: promotion latency | holder release -> first waiter served | (observed) | 93ms | INFO |
| CP11 | depth 10: drain time (includes client notice latency) | holder release -> last waiter served | (observed) | 5102ms | INFO |
...
| CP16 | depth 50: promotion latency | holder release -> first waiter served | (observed) | -137ms | INFO |
| CP17 | depth 50: drain time (includes client notice latency) | holder release -> last waiter served | (observed) | 20120ms | INFO |
| CP18 | depth 50: resource free afterwards | Groovy resource state on b | free: not locked, no lease, not reserved | free | PASS |
| CP19 | Promotion latency, shallowest vs deepest queue | depth 1 vs depth 50 | (observed) | 48ms vs depth=50 served=50 promotion_ms=-137 drain_ms=20120ms | INFO |
...
- depth_1_drain_ms: 48
- depth_10_served: 10
- depth_10_first_ms: 93
- depth_10_drain_ms: 5102
- depth_50_served: 50
- depth_50_first_ms: -137
- depth_50_drain_ms: 20120
- depths: 1 10 50
- promotion_ms_shallow: 48
- promotion_ms_deep: depth=50 served=50 promotion_ms=-137 drain_ms=20120

#### Artifacts

- scaling measurements: /home/ksato/projects/jenkins/rlr/lockable-resources-remote-notes/dev/jenkins-env/../reports/20260812143519-e2e-test/queue-depth-scale/queue-scaling.txt
