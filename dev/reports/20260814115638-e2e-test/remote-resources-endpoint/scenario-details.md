...
| CP02 | The exposed resource is listed | grep resources.json | contains 's19-exposed-1786677042' | found | PASS |
| CP03 | exposeLabel is the visibility boundary | grep resources.json | does not contain 's19-hidden-1786677042' | absent | PASS |
...
- http_code: 200
- exposed_resource: s19-exposed-1786677042
- hidden_resource: s19-hidden-1786677042

#### Artifacts

- response: /home/ksato/projects/jenkins/rlr/lockable-resources-remote-notes/dev/jenkins-env/../reports/20260814115638-e2e-test/remote-resources-endpoint/resources.json
- response while paused: /home/ksato/projects/jenkins/rlr/lockable-resources-remote-notes/dev/jenkins-env/../reports/20260814115638-e2e-test/remote-resources-endpoint/resources-paused.json
