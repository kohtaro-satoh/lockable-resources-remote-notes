...
| CP10 | depth 10: promotion latency | holder release -> first waiter served | (observed) | 96ms | INFO |
| CP11 | depth 10: drain time (includes client notice latency) | holder release -> last waiter served | (observed) | 5075ms | INFO |
...
| CP16 | depth 50: promotion latency | holder release -> first waiter served | (observed) | 109ms | INFO |
| CP17 | depth 50: drain time (includes client notice latency) | holder release -> last waiter served | (observed) | 17483ms | INFO |
| CP18 | depth 50: resource free afterwards | Groovy resource state on b | free: not locked, no lease, not reserved | free | PASS |
| CP19 | Promotion latency, shallowest vs deepest queue | depth 1 vs depth 50 | (observed) | 46ms vs 109ms | INFO |
...
- depth_1_drain_ms: 46
- depth_10_served: 10
- depth_10_first_ms: 96
- depth_10_drain_ms: 5075
- depth_50_served: 50
- depth_50_first_ms: 109
- depth_50_drain_ms: 17483
- depths: 1 10 50
- promotion_ms_shallow: 46
- promotion_ms_deep: 109

#### Artifacts

- scaling measurements: /home/ksato/projects/jenkins/rlr/lockable-resources-remote-notes/dev/jenkins-env/../reports/20260815160700-e2e-test/queue-depth-scale/queue-scaling.txt
