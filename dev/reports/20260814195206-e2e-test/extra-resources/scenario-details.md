...
|---|---|---|---|---|---|
| CP01 | Main resource held remotely during the body | Groovy resource state on b | held by a remote lease | lease=6dc8268c-10fb-41d2-b6c7-44599adf4fe1 | PASS |
| CP02 | Extra joined the same lease (atomic) | Groovy getRemoteLockedBy on B | 6dc8268c-10fb-41d2-b6c7-44599adf4fe1 | 6dc8268c-10fb-41d2-b6c7-44599adf4fe1 | PASS |
| CP03 | Build result | Build API | SUCCESS | SUCCESS | PASS |
| CP04 | Combined variable names the main resource | grep console.txt | contains 's10-res1-1786705115' | found | PASS |
| CP05 | Combined variable names the extra resource | grep console.txt | contains 's10-res2-1786705115' | found | PASS |
...
- result: SUCCESS
- S10RES: s10-res1-1786705115,s10-res2-1786705115
- S10RES0: s10-res1-1786705115
- S10RES1: s10-res2-1786705115
- lease_main: 6dc8268c-10fb-41d2-b6c7-44599adf4fe1
- lease_extra: 6dc8268c-10fb-41d2-b6c7-44599adf4fe1

#### Artifacts

- console: /home/ksato/projects/jenkins/rlr/lockable-resources-remote-notes/dev/jenkins-env/../reports/20260814195206-e2e-test/extra-resources/console.txt
