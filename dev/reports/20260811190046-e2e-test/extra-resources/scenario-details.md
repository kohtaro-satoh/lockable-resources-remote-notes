...
|---|---|---|---|---|---|
| CP01 | Main resource held remotely during the body | Groovy resource state on b | held by a remote lease | lease=fa479fee-5279-4738-aa21-9551d7364f45 | PASS |
| CP02 | Extra joined the same lease (atomic) | Groovy getRemoteLockedBy on B | fa479fee-5279-4738-aa21-9551d7364f45 | fa479fee-5279-4738-aa21-9551d7364f45 | PASS |
| CP03 | Build result | Build API | SUCCESS | SUCCESS | PASS |
| CP04 | Combined variable names the main resource | grep console.txt | contains 's10-res1-1786442846' | found | PASS |
| CP05 | Combined variable names the extra resource | grep console.txt | contains 's10-res2-1786442846' | found | PASS |
...
- result: SUCCESS
- S10RES: s10-res1-1786442846,s10-res2-1786442846
- S10RES0: s10-res1-1786442846
- S10RES1: s10-res2-1786442846
- lease_main: fa479fee-5279-4738-aa21-9551d7364f45
- lease_extra: fa479fee-5279-4738-aa21-9551d7364f45

#### Artifacts

- console: /home/ksato/projects/jenkins/rlr/lockable-resources-remote-notes/dev/jenkins-env/../reports/20260811190046-e2e-test/extra-resources/console.txt
