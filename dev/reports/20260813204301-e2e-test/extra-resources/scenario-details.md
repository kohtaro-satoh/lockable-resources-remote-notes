...
|---|---|---|---|---|---|
| CP01 | Main resource held remotely during the body | Groovy resource state on b | held by a remote lease | lease=dd0e348a-a0e8-44cc-8e0e-6dc4c91ff616 | PASS |
| CP02 | Extra joined the same lease (atomic) | Groovy getRemoteLockedBy on B | dd0e348a-a0e8-44cc-8e0e-6dc4c91ff616 | dd0e348a-a0e8-44cc-8e0e-6dc4c91ff616 | PASS |
| CP03 | Build result | Build API | SUCCESS | SUCCESS | PASS |
| CP04 | Combined variable names the main resource | grep console.txt | contains 's10-res1-1786621770' | found | PASS |
| CP05 | Combined variable names the extra resource | grep console.txt | contains 's10-res2-1786621770' | found | PASS |
...
- result: SUCCESS
- S10RES: s10-res1-1786621770,s10-res2-1786621770
- S10RES0: s10-res1-1786621770
- S10RES1: s10-res2-1786621770
- lease_main: dd0e348a-a0e8-44cc-8e0e-6dc4c91ff616
- lease_extra: dd0e348a-a0e8-44cc-8e0e-6dc4c91ff616

#### Artifacts

- console: /home/ksato/projects/jenkins/rlr/lockable-resources-remote-notes/dev/jenkins-env/../reports/20260813204301-e2e-test/extra-resources/console.txt
